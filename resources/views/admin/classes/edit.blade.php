...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-header">
            ...
            <p class="page-subtitle">Update class information and assignments</p>
        </div>
            ...
            <form action="{{ route('admin.classes.update', $class->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" 
                              ...
                              name="description" 
                              rows="4" 
                              placeholder="Enter class description, schedule, or additional information...">{{ old('description', $class->description) }}</textarea>
                </div>
