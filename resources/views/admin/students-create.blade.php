                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Create a new student account and assign them to a classroom</p>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="{{ old('email') }}" required placeholder="student@school.com">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-4">
                                    <label for="classroom" class="form-label">
                                        Classroom Assignment <span class="required">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                        ...
                                        <select class="form-select" id="classroom" name="classroom" required>
                                            ...
                                            @foreach($classrooms as $classroom)
                                                <option value="{{ $classroom }}" {{ old('classroom') == $classroom ? 'selected' : '' }}>
                                                    {{ $classroom }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <small class="text-muted">Assign this student to a specific classroom</small>
                                </div>
                            </div>
                        </div>
