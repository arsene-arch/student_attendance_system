...
<head>
    ...
    <title>Add Teacher - Attendance System</title>
                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Create a new teacher account and assign them to a classroom</p>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" 
                                               value="{{ old('name') }}" required placeholder="Enter teacher's full name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="{{ old('email') }}" required placeholder="teacher@school.com">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <small class="text-muted">Assign this teacher to a specific classroom</small>
                                </div>
                            </div>
                        </div>
